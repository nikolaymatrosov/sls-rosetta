...
resource "yandex_iam_service_account" "producer_sa" {
  name        = "yds-producer-sa-python"
  description = "Service account for YDS producer function"
  folder_id   = var.folder_id
}

# Service Account for Consumer Function
resource "yandex_iam_service_account" "consumer_sa" {
  name        = "yds-consumer-sa-python"
  description = "Service account for YDS consumer function"
  folder_id   = var.folder_id
}

# Service Account for Trigger
resource "yandex_iam_service_account" "trigger_sa" {
  name        = "yds-trigger-sa-python"
  description = "Service account for YDS trigger"
  folder_id   = var.folder_id
}
